          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#191a2c] border-white/10 rounded-2xl p-5">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <div className="h-4 w-12 bg-gray-700 animate-pulse rounded mb-1"></div>
                  <div className="h-8 w-20 bg-gray-700 animate-pulse rounded"></div>
                </div>
                <div className="flex bg-white/5 rounded-xl p-1">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="h-8 w-12 bg-gray-700 animate-pulse rounded-lg mx-1"></div>
                  ))}
                </div>
              </div>
              <div className="h-48 bg-gray-800 animate-pulse rounded"></div>
            </div>

            {/* Volume Stats Skeleton */}
            <div className="bg-[#191a2c] border-white/10 rounded-2xl p-5">
              <div className="h-4 w-16 bg-gray-700 animate-pulse rounded mb-4"></div>
              <div className="space-y-6">
                <div className="flex gap-6">
                  <div className="flex-1">
                    ...
                    <div className="h-1 bg-gray-700 animate-pulse rounded"></div>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <div className="h-4 w-16 bg-gray-700 animate-pulse rounded"></div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i}>
                      <div className="h-4 w-20 bg-gray-700 animate-pulse rounded mb-1"></div>
            ...
            <div className="bg-[#191a2c] border-white/10 rounded-2xl p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-6 border border-white/10 rounded-xl">
                  ...
                  <div className="h-6 w-4 bg-gray-700 animate-pulse rounded"></div>
                </div>
                <div className="flex items-center justify-between p-6 border border-white/10 rounded-xl">
                  <div className="flex items-center gap-2">
                ...
                <div className="h-12 w-full bg-gray-700 animate-pulse rounded-lg"></div>
              </div>
            </div>

            {/* Description Skeleton */}
            <div className="bg-[#191a2c] border-white/10 rounded-2xl p-5">
              <div className="h-4 w-20 bg-gray-700 animate-pulse rounded mb-4"></div>
