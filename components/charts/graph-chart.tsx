...
import { Chip, Button, Card, cn, Dropdown, DropdownItem, DropdownMenu, DropdownTrigger, Tab, Tabs, Spacer } from "@heroui/react";
...
export default function Component() {
  ...
  const activeChartData = React.useMemo(() => {
    ...
    return {
      ...
      color: chart?.changeType === "positive" ? "success" : chart?.changeType === "negative" ? "danger" : "default",
      suffix: chart?.suffix,
      type: chart?.type,
    };
  }, [activeChart]);
  ...
  return (
    <Card as="dl" className="dark:border-default-100 border border-transparent">
      <section className="flex flex-col flex-nowrap">
        ...
        <ResponsiveContainer className="min-h-[300px] [&_.recharts-surface]:outline-hidden" height="100%" width="100%">
          <AreaChart
            accessibilityLayer
            data={chartData}
            height={300}
