        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3.5 h-3.5 rounded-full transition-all duration-200 ${
              index === currentSlide ? "bg-white scale-110" : "bg-[#191a2c] hover:bg-gray-600"
            }`}
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                <Card className="flex items-center justify-center mx-auto w-[350px] h-[518px] bg-[url('/image/hubra-m.png')] bg-cover bg-center rounded-2xl relative overflow-hidden">
                  ...
                  <Image alt="Hubra" className="relative top-[-9px] left-[2px]" height={300} src="/image/wgroup-m2.png" width={238} />
                  <WalletEnergyFlow />
                </Card>
            ...
            <div className="flex-1 w-full">
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  {activeTab === "normies" && (
                    <Card className="flex items-center justify-center mx-auto w-full h-[398px] bg-[url('/image/hubra-m.png')] bg-no-repeat  bg-center bg-cover rounded-2xl relative overflow-hidden">
                      <div className="flex items-center justify-center relative">
                        <div
                          ...
                          <span className="absolute left-[7%] top-[46%] lg:top-[50%] z-10 w-[130px] lg:w-[150px] h-[42px] inline-block text-xl lg:text-2xl font-bold leading-[42px] text-gradient-brand text-center tracking-[1px]">
                            You.hub
                          </span>
                          <span className="absolute left-[70%] top-[46%] lg:top-[50%] z-10 w-[130px] lg:w-[150px] h-[46px] inline-block text-xl lg:text-2xl font-bold leading-[42px] text-gradient-brand text-center tracking-[1px]">
                            Friend.hub
                          </span>
                          <div className="absolute left-[25.8%] lg:left-[24.8%] xl:left-[23.4%] top-[45%] lg:top-[44%] xl:top-[42%] z-20 backdrop-blur-sm bg-transparent rounded-xl">
                            <Image
                              alt="Hubra"
                          ...
                          <div className="absolute left-[90.5%] lg:left-[90%] xl:left-[88%] top-[45%] lg:top-[44%] xl:top-[42%] z-30 backdrop-blur-sm bg-transparent rounded-xl">
                            <Image
                              alt="Hubra"
                              className="w-[45px] h-[43px] lg:w-[59px] lg:h-[51px] xl:w-[75px] xl:h-[63px]"
                              height={63}
                      ...
                      <WalletEnergyFlow className="w-[650px] h-[182px] lg:w-[850px] lg:h-[208px] xl:w-[850px] xl:h-[208px]" />
                      <Image
                        alt="token"
          ...
          <div className="flex flex-row items-center justify-between w-full mx-auto">
              ...
              <div className="w-fit h-full flex flex-col items-start justify-between">
                <span
                  className={`text-2xl font-semibold font-sans transition-all duration-300 ${
                    activeTab === "normies" ? "text-white" : "text-white opacity-50 hover:opacity-75"
                  }`}>
                  Normies
                </span>
                <p className="font-geist text-gray-400/70 text-body">No complicated jargon. Effortless onboarding</p>
            ...
            <button
              ...
              <div className="w-fit h-full flex flex-col items-start justify-between">
                <span
                  className={`text-2xl font-semibold font-sans  transition-all duration-300 ${
                    activeTab === "degens" ? "text-white" : "text-white opacity-50 hover:opacity-75"
                  }`}>
                  Degens
                </span>
                <p className="font-geist text-gray-400/70 text-body">Powerful DeFi tools. Endless possibilities</p>
        ...
        <div className="flex flex-col gap-16 md:flex-row justify-between items-start w-full">
          ...
          <div className="flex items-start gap-4 md:gap-8 relative flex-1 grow w-full">
            <div className="flex flex-col items-start md:items-end justify-center gap-4 flex-1 grow">
              <h4 className="font-sans text-white text-sm sm:text-base md:text-lg text-left md:text-right">Product</h4>
            ...
            <div className="flex flex-col items-start md:items-end justify-center gap-4 flex-1 grow">
              <h4 className="font-sans text-white text-sm sm:text-base md:text-lg text-left md:text-right">Community</h4>
              <div className="flex flex-col items-start md:items-end text-xs sm:text-sm md:text-base justify-center gap-3 w-full">
                <div className="inline-flex items-center gap-2">
                  <div className="inline-flex items-center justify-center gap-2">
                    <Link
            ...
            <div className="flex flex-col items-start md:items-end justify-center gap-4 flex-1 grow">
              <h4 className="font-sans text-white text-sm sm:text-base md:text-lg text-left md:text-right">Resources</h4>
              <div className="flex flex-col items-start md:items-end text-xs sm:text-sm md:text-base justify-center gap-3 w-full">
                <div className="inline-flex items-center gap-2">
                  <div className="inline-flex items-center justify-center gap-2">
                    <Link
        ...
        <div className="flex flex-col items-start gap-8 w-full">
          <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center justify-between w-full">
            ...
            <div className="inline-flex items-center gap-6">
              ...
              <Link className="" href="https://discord.hubra.app" target="_blank">
                <Icon className="w-6 h-6 cursor-pointer text-[#797B92] hover:text-white" icon="ri:discord-fill" />
              </Link>
            </div>
          </div>
        </div>
